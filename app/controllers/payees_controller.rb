class PayeesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payee.save
        format.html { redirect_to @payee, notice: t('Payee was successfully created.') }
  ...
  def update
    respond_to do |format|
      if @payee.update(payee_params)
        format.html { redirect_to @payee, notice: t('Payee was successfully updated.') }
  ...
  def destroy
    @payee.destroy
    respond_to do |format|
      format.html { redirect_to payees_url, notice: t('Payee was successfully destroyed.') }
  ...
  private
    ...
    def payee_params
      params.require(:payee).permit(:code, :name, :brief_name, :status)
    end
end
